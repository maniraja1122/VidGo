import 'package:VidGo/ListLayouts/MessageItem.dart';
        ...
        title: StreamBuilder(
          ...
          builder: (BuildContext context,
            ...
            if (snapshot.hasError) {
              ...
              return Text(data.get("Name",), style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),);
            }
            return Text("Fetching", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),);
          },
        ),
      ),
      body: SafeArea(
